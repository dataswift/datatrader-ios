...
internal class MailManagerViewController: BaseViewController, MFMailComposeViewControllerDelegate {
     ...
     */
    func sendEmail(atAddress: String, onBehalf ofViewController: BaseViewController) {
        ...
        if MFMailComposeViewController.canSendMail() {
            ...
            ofViewController.createDressyClassicOKAlertWith(
